#ifndef SIRE_RENDERINGWIDGET_H
#define SIRE_RENDERINGWIDGET_H
...
class RenderingWidget : public nanogui::Screen
{
  ...
  protected:
    ...
    virtual void dropEvent(const std::vector<std::string> &filenames);
